...
export default function CreateQuizPage() {
  ...
  // --- SUPPRIMER: const [isLoading, setIsLoading] = useState(false) ---
  const [formData, setFormData] = useState<QuizFormData>({
    title: '',
    description: ''
  })
  // Nouvel état local pour afficher l'erreur si la mutation échoue
  ...
  const createQuizMutation = useMutation({
    ...
    onSuccess: (newQuiz) => {
      // 1. Invalider le cache de la liste des quiz pour rafraîchir le Dashboard
